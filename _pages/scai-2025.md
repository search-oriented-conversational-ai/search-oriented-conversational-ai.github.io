...
| --- | --- |
| Welcome <br> *Svitlana Vakulenko (WU Vienna University of Economics and Business)* [<a href="/assets/scai-2025/vendi">slides</a>] |
| LLMs in Retrieval -- Mapping Potential and Pitfalls <br> *Vaibhav Adlakha (McGill University/Mila - Quebec AI Institute)* [<a href="/assets/scai-2025/50k">slides</a>] |
| Question Answering over Structured Data and Unstructured Text <br> *Philipp Christmann (Max Planck Institute for Informatics)* [<a href="/assets/scai-2025/chris">slides</a>] |
| TEARS: Textual Representations for Scrutable Recommendations <br> *Laurent Charlin (HEC Montreal)* [<a href="/assets/scai-2025/laurent">slides</a>] |
| Subjective Debate as Conversational Search: Simulating Sales Negotiations Grounded in Preferences <br> *Vahid Sadiri Javadi (University of Bonn)* [<a href="/assets/scai-2025/vahid">slides</a>] |
| Evaluation challenges in the LLM era <br> *Patricia Schmidtova (Charles University)* [<a href="/assets/scai-2025/patricia">slides</a>] |
| Enhancing model transparency: Effects of DK Integration for conversational XAI <br> *Isabel Feustel (Ulm University)* [<a href="/assets/scai-2025/rexipa">slides</a>] |
|
